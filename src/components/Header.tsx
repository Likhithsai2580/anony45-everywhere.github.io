    ...
    <header className="bg-white dark:bg-gray-900 shadow-md py-4 fixed top-0 left-0 right-0 z-10">
      <nav className="container mx-auto px-4 flex justify-between items-center">
        ...
        <ul className="flex space-x-6 items-center">
          ...
          <li><Link href="/Resume.pdf" className="bg-blue-600 text-white dark:bg-blue-500 dark:text-gray-100 px-4 py-2 rounded-full hover:bg-blue-700 dark:hover:bg-blue-600 transition duration-300">Resume</a></li>
